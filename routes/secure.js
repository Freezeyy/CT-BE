...
router.post('/admin/programs', m.requireAdmin, c.admin.createProgram);
...
router.get('/super-admin/campuses', m.requireAdmin, c.superAdmin.listCampuses);
router.post('/super-admin/campuses', m.requireAdmin, c.superAdmin.createCampus);
router.put('/super-admin/campuses/:campus_id', m.requireAdmin, c.superAdmin.updateCampus);
router.delete('/super-admin/campuses/:campus_id', m.requireAdmin, c.superAdmin.deleteCampus);
...
router.put('/lecturer/profile', m.requireAdminOrUser, c.profile.updateLecturerProfile);
...
router.get('/template3/:template3Id/evaluation', m.requireAdminOrUser, c.template3.getTemplate3Evaluation);
